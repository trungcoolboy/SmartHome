...
export const pageContent = {
  ...
  "bathroom-1": {
    ...
    roomNode: {
      ...
      relays: [
        { key: "relay1", label: "Relay 1", displayLabel: "Bathroom 1 Light" },
        { key: "relay2", label: "Relay 2", displayLabel: "Bathroom 1 Fan" },
      ],
      touches: [
        { key: "relay1", label: "Touch 1" },
        { key: "relay2", label: "Touch 2" },
      ...
      remoteRelayLabel: "Water Heater (Remote)",
      remoteRelayDisplayLabel: "Bathroom 1 Water Heater (Remote)",
    ...
    roomNodeSecondary: {
      ...
      relays: [{ key: "relay", label: "Hot Water Relay", displayLabel: "Bathroom 1 Water Heater" }],
